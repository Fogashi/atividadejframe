...
public class cadastro extends JFrame {
	 ...
	 */
	public cadastro() {
		setForeground(new Color(128, 255, 0));
		setResizable(false);
		...
		lblIdade.setForeground(new Color(128, 255, 0));
		lblIdade.setFont(new Font("Segoe UI", Font.PLAIN, 11));
		lblIdade.setBounds(59, 94, 37, 14);
		contentPane.add(lblIdade);
		
		JLabel lblSexo = new JLabel("Sexo:");
		lblSexo.setForeground(new Color(128, 255, 0));
		lblSexo.setFont(new Font("Segoe UI", Font.PLAIN, 11));
		...
		lblNewLabel_4.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 22));
